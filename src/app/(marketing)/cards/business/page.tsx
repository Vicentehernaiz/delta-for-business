...
import { cards, businessCardOrder } from '@/config/cards'

export const metadata: Metadata = {
  title: 'Delta SkyMiles® Business Credit Cards | Delta for Business',
  description:
    'Apply for Delta SkyMiles American Express business credit cards: Gold ($150), Platinum ($350), and Reserve ($650). Earn miles on business spend — shipping, advertising, and more.',
...
// Gold = #8f6c32 amber-gold · Platinum = #6f7f8d silver-grey · Reserve = #726394 purple
    ...
    <main>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p style={{ fontSize: 'var(--type-scale-18)', color: 'rgba(255,255,255,0.8)', maxWidth: '560px', margin: '0 auto 32px' }}>
            Earn on the categories that drive your business — Delta purchases, shipping, and advertising. Every card includes an MQD boost for faster Medallion status.
          </p>
      ...
      <section style={{ background: 'var(--color-neutral-5)', borderBottom: '1px solid var(--color-neutral-10)' }}>
        <div className="max-w-5xl mx-auto px-6 py-6 grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { label: 'Entry fee (first year free)', value: '$150', desc: 'Gold Business' },
            { label: 'Top welcome bonus', value: '80K miles', desc: 'Reserve Business' },
            { label: 'Max earning on Delta', value: '3x miles', desc: 'Platinum & Reserve' },
      ...
      {/* Why business cards callout */}
      <section className="py-12 px-6" style={{ background: 'var(--color-neutral-5)' }}>
        <div className="max-w-5xl mx-auto">
          <h2 style={{ fontSize: 'var(--type-scale-22)', fontWeight: '700', color: 'var(--color-delta-blue-700)', marginBottom: '16px' }}>
            Why a business card?
          </h2>
            ...
            {[
              {
                ...
                title: 'Business-category bonuses',
                body: 'Earn double miles on US shipping and US advertising — categories not available on personal cards.',
              },
              {
                icon: 'ph-fill ph-buildings',
                title: 'Separate business spend',
                body: 'Keep personal and business expenses apart for cleaner accounting and simpler expense reporting.',
              },
              {
                icon: 'ph-fill ph-medal',
                title: 'Dual MQD earning',
                body: 'Card spend boosts your personal Medallion status while your company earns miles through the Delta for Business program.',
              },
            ].map((b) => (
              <div
                key={b.title}
      ...
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p style={{ fontSize: 'var(--type-scale-16)', color: 'var(--color-neutral-600)', marginBottom: '24px' }}>
            Compare all 7 cards side-by-side or take our 60-second program quiz.
          </p>
