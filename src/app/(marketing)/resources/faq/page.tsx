...
const faqSections = [
  {
    ...
    faqs: [
      { q: 'Which Delta for Business program is right for me?', a: 'It depends on your company size and travel volume. Individual Business Traveler is free for anyone traveling for work solo. SkyMiles for Business (Small Business) is for companies with 1–50 travelers spending $5K+/year — it gives the company dual-earn miles. Mid-Market is for $50K–$300K spend with negotiated fares and Corporate Priority. Enterprise is for $300K+ companies with global coverage. Use the program selector quiz to get a personalized recommendation.' },
  ...
  },
  {
    ...
    faqs: [
      { q: 'How do I enroll my company?', a: 'For Individual Traveler and Small Business programs: enroll at delta.com/business — takes about 5 minutes. For Mid-Market and Enterprise programs: complete the sales inquiry form and a Delta representative will contact you within 2 business days.' },
