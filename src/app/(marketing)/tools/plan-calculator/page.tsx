...
const PLAN_CATALOG: Record<PlanKey, PlanInfo> = {
  individual: {
    ...
    benefits: [
      'Personal SkyMiles on every Delta flight',
      'Hertz Business Rewards · CLEAR Plus discount',
      'LinkedIn Premium offer',
      'No employer or company account needed',
      'Switch to a corporate plan whenever',
    ],
